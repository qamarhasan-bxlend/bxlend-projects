...
it("should list Manual Withdraw Transactions", async () => {
...
it("should list 0 Manual Withdraw Transactions, if page doesn't exist", async () => {
...
it("should list only limited amount of Manual Withdraw Transactions", async () => {
  const { factory, serializeDocument, http } = require("@tests/internals");
  const { STATUS_CODE } = require("@src/constants");
...
it("should not be able to list all of the Manual Withdraw Transactions", async () => {
  const { factory, http } = require("@tests/internals");
  const { STATUS_CODE } = require("@src/constants");
