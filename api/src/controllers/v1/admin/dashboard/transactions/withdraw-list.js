...
const CONTROLLER = [
    ...
    async function listWithdrawTransactionsDashboardAdminV1Controller(req, res) {
        ...
        const { total_count, model_count } = await dashboardFilters(StatusCounts, duration, Transaction, STATUS, TRANSACTION_KIND.WITHDRAW)

        res.json({
            total_count,
            withdraw_transaction_count: model_count
        })
    }
];
